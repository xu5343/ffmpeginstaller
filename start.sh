...
if [ -e "/etc/yum.conf" ];then
	...
	yum install -y epel-release
        ...
        yum install -y \
        gcc gcc-c++ libgcc glib glib2 unzip bzip2 dos2unix openssl make cmake automake autoconf patch git ruby ncurses ncurses-devel mercurial hg neon expat expat-devel alsa-lib \
